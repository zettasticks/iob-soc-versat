...
void SingleTest(Arena* arena){
   ...
   Assert_Eq(accelState->shares_0.outputs_0.currentValue,5);
   Assert_Eq(accelState->shares_0.outputs_1.currentValue,20);
   Assert_Eq(accelState->shares_0.outputs_2.currentValue,15);
   Assert_Eq(accelState->shares_0.outputs_3.currentValue,20);
