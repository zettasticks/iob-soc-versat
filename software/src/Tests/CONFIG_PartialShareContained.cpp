...
void SingleTest(Arena* arena){
   ...
   Assert_Eq(accelState->TOP_shares_0_outputs_0_currentValue,5);
   Assert_Eq(accelState->TOP_shares_0_outputs_1_currentValue,20);
   Assert_Eq(accelState->TOP_shares_0_outputs_2_currentValue,15);
   Assert_Eq(accelState->TOP_shares_0_outputs_3_currentValue,20);
